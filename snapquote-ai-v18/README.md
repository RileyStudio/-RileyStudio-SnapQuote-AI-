...
1. **Landing page** (`/`) — read the Founding Contractor pitch, click
   "Try Demo." ("See Sample Quote" and the "Showcase" placeholder section
...
9. **Customer quote** — tap "View as Customer" to see the branded,
   work-order-styled quote exactly as a real customer would.
