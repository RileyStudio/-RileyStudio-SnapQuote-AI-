...
-- ─────────────────────────────────────────────────────────
-- customers (Phase 8) — contractor-owner-only. Never exposed publicly;
-- the public quote page only ever sees the flattened customer_name/etc.
-- columns on estimates (via get_quote_by_token()), not this table.
-- ─────────────────────────────────────────────────────────
alter table customers enable row level security;

create policy "customers: contractor manages own"
