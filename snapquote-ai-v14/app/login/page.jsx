  ...
  return (
    <main className="min-h-screen flex flex-col justify-center px-5 py-10">
      <div className="max-w-sm w-full mx-auto">
        ...
        {/* Always available — demo mode must work even if Supabase is
            present but misconfigured, not just when it's absent entirely.
            Plain native <button>, not BigButton, so there's no component
            prop/event-handling surface between this click and the
